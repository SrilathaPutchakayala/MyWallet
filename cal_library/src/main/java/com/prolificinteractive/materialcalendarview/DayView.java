...
class DayView extends CheckedTextView {
    ...
    public void setDayFormatter(DayFormatter formatter) {
        ...
        //Log.v("Current Label","====CURRENT LABEL======"+currentLabel);
        Object[] spans = null;
...
//        API 22. Technically harmless to leave on for API 21 and 23, but not worth risking for 23+
    ...
    private void calculateBounds(int width, int height) {
        ...
        //width = width+50;
        //height = height+30;
        final int radius = Math.min(height, width);//-30;
        final int offset = Math.abs(height - width) / 2;// / 3;
        ...
        //Log.v("offset Before","=====OFFSET BEFORE====="+offset);
        ...
        /*Log.v("offset Before","=====OFFSET AFTER====="+circleOffset);
        Log.v("Width==","======WIDTH======="+width);
        Log.v("height==","======height======="+height);*/
