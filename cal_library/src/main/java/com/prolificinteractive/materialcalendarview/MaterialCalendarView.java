...
public class MaterialCalendarView extends ViewGroup {
    ...
    public String getTitle() {
        return titleChanger.getTitle();//getText().toString();
    }
    ...
    private OnDateClickedListener dateClickedListener;
    ...
    public MaterialCalendarView(Context context, AttributeSet attrs) {
        ...
        //Log.v("currentMonth", "=======currentMonth==========" + currentMonth.getDate());
    ...
    private void setupChildren() {
        ...
        //topbar.setLayoutParams(new LinearLayout.LayoutParams(0, 600));
    ...
    public void setSelectedDates(List<Date> selectedDates) {
        ...
        List<CalendarDay> selectedCalendarDates = new ArrayList<>();

        for (int i = 0; i < selectedDates.size(); i++) {
            selectedCalendarDates.add(CalendarDay.from(selectedDates.get(i)));
        }
        Log.v("Inside set method", "=====setSelectedDates=====" + selectedDates.size());

        adapter.setSelectedDates(selectedCalendarDates);
    ...
    public void setOnDateClickListener(final OnDateClickedListener listener) {
        this.dateClickedListener = listener;
    }
    ...
    protected void dispatchOnDateClicked(final CalendarDay day, final boolean selected) {
        OnDateClickedListener l = dateClickedListener;
        if (l != null) {
    ...
    protected void onDateClicked(@NonNull CalendarDay date, boolean nowSelected) {
        switch (selectionMode) {
            ...
            case SELECTION_MODE_SINGLE: {
                ...
                dispatchOnDateClicked(date, true);
